...
export function RepoNav({ owner, repo, openIssueCount, openPrCount }: RepoNavProps) {
  ...
  const tabs = [
    ...
    },
    {
      ...
      active: path.startsWith(`/${owner}/${repo}/issues`) || path.startsWith(`/${owner}/${repo}/issue/`),
      icon: (
        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      active: path.startsWith(`/${owner}/${repo}/pulls`) || path.startsWith(`/${owner}/${repo}/pull/`),
      icon: (
        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
