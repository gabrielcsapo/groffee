      ...
      <body className="flex flex-col min-h-screen">
        <header className="bg-text-primary shadow-md sticky top-0 z-30">
          <nav className="max-w-[1280px] mx-auto px-6 h-16 flex items-center gap-6">
            <Link to="/" className="text-white font-semibold text-lg hover:no-underline flex items-center gap-2 shrink-0">
              <GroffeeLogo size={32} className="text-white" />
              Groffee
            </Link>
            <Link to="/explore" className="text-white/70 text-sm hover:text-white hover:no-underline">
              Explore
            </Link>
        ...
        <footer className="border-t border-border mt-auto">
          <div className="max-w-[1280px] mx-auto px-6 py-6 flex items-center justify-between text-xs text-text-secondary">
            ...
            <div className="flex items-center gap-4">
              <Link to="/explore" className="text-text-secondary hover:text-text-primary hover:no-underline">Explore</Link>
              <Link to="/docs" className="text-text-secondary hover:text-text-primary hover:no-underline">API Docs</Link>
