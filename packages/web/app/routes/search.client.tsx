    ...
    <div className="max-w-5xl mx-auto mt-8">
      ...
      {!searched ? (
        ...
        <div className="flex flex-col md:flex-row gap-6">
          {/* Mobile-only horizontal tab strip + Languages dropdown.
              On md+ this whole block hides and the desktop sidebar (below)
              renders the same controls vertically. */}
          ...
          {/* Desktop sidebar (md+) with type counts */}
